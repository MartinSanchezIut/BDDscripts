...
CREATE MATERIALIZED VIEW OCC_GARE AS SELECT * FROM GARE;
CREATE MATERIALIZED VIEW OCC_TRAIN AS SELECT * FROM TRAIN;
CREATE MATERIALIZED VIEW OCC_DATE_DATE AS SELECT * FROM DATE_DATE;
CREATE MATERIALIZED VIEW OCC_DATE_TIME AS SELECT * FROM DATE_TIME;
...
CREATE TABLE TRAJET (
    ...
    FOREIGN KEY (ID_GARE_DEPART) REFERENCES OCC_GARE(ID_GARE),
    FOREIGN KEY (ID_GARE_ARRIVEE) REFERENCES OCC_GARE(ID_GARE),
    FOREIGN KEY (ID_TRAIN) REFERENCES OCC_TRAIN(ID_TRAIN),
    FOREIGN KEY (ID_DATE) REFERENCES OCC_DATE_DATE(ID_DATE),
    FOREIGN KEY (ID_TIME) REFERENCES OCC_DATE_TIME(ID_TIME),
