...
--CREATE MATERIALIZED VIEW OCC_GARE(ID_GARE, NOM_GARE, REGION_GARE, CODE_REGION_GARE, DEPARTEMENT_GARE, CODE_DEPARTEMENT_GARE, VILLE_GARE, CODE_VILLE_GARE)
--AS SELECT * FROM GARE;

--CREATE MATERIALIZED VIEW OCC_TRAIN(ID_TRAIN, TYPE_TRAIN, NMBR_PLACES, NMBR_WAGON, DATE_MISE_EN_SERVICE, LIEU_DEPOT)
--AS SELECT * FROM TRAIN;

--CREATE MATERIALIZED VIEW OCC_DATE_DATE(ID_DATE, JOUR, MOIS, ANNEE, SAISON, NUM_SEMAINE, NUM_TRIMESTRE)
--AS SELECT * FROM DATE_DATE;

--CREATE MATERIALIZED VIEW OCC_DATE_TIME(ID_TIME, HEURES, MINUTES, SECONDES)
